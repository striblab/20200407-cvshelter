...
```html
<div
  data-pym-src="https://static.startribune.com/news/projects/all/20200331-cvimpact/?pym=true"
>
  Loading...
</div>
<script
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/20200331-cvimpact/",
      "url": "http://static.startribune.com/news/projects-staging/all/20200331-cvimpact/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/20200331-cvimpact/",
      "url": "http://static.startribune.com/news/projects/all/20200331-cvimpact/"
    }
  }
}
```
